...
var dialogBox = function dialogBox(selectedLayers) {
  var alert = Object(_lib_dialogFields__WEBPACK_IMPORTED_MODULE_5__["dialogAlert"])("Export Spacing Tokens"); // Creating the view
...
var exportTextstyles = function exportTextstyles(selectedLayers, type, format, naming, units) {
  ...
  if (savePanel.runModal() && selectedCount !== 0) {
    ...
    sketch__WEBPACK_IMPORTED_MODULE_0___default.a.UI.message('Spacing Tokens Exported!');
  }
};
/**
 * 
