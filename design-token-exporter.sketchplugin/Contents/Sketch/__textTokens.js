...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/textTokens.js");
/******/ })
/************************************************************************/
/******/ ({
...
var dialogBox = function dialogBox(selectedLayers) {
  var alert = Object(_lib_dialogFields__WEBPACK_IMPORTED_MODULE_6__["dialogAlert"])('Export Text Variables'); // Creating the view
  ...
  view.addSubview(Object(_lib_dialogFields__WEBPACK_IMPORTED_MODULE_6__["fieldLabel"])(90, 'Select values:', viewWidth, viewHeight));
...
var exportTextstyles = function exportTextstyles(selectedLayers, type, format, naming, units) {
  ...
  if (savePanel.runModal() && selectedCount !== 0) {
    ...
    var file = NSString.stringWithString(Object(_lib_formatObject__WEBPACK_IMPORTED_MODULE_4__["default"])(variables, type, format));
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  var selected = doc.selectedLayers.layers; // Only Text layers - no shape layers

  var selectedLayers = lodash__WEBPACK_IMPORTED_MODULE_1___default.a.filter(lodash__WEBPACK_IMPORTED_MODULE_1___default.a.reverse(selected), ['type', 'Text']);
...
//# sourceMappingURL=__textTokens.js.map