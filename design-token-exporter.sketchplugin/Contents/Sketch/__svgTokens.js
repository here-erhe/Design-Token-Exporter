...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/svgTokens.js");
/******/ })
/************************************************************************/
/******/ ({
...
var dialogBox = function dialogBox(selectedLayers) {
  ...
  view.addSubview(dropdownFileType); //Dropdown: Naming

  view.addSubview(Object(_lib_dialogFields__WEBPACK_IMPORTED_MODULE_6__["fieldLabel"])(90, 'Naming:', viewWidth, viewHeight));
  dropdownNames = Object(_lib_dialogFields__WEBPACK_IMPORTED_MODULE_6__["fieldSelect"])(100, selectedLayers, viewWidth, viewHeight, true);
...
var exportSVG = function exportSVG(selectedLayers, type, naming) {
  ...
  if (openPanel.runModal() && selectedCount !== 0) {
    ...
    lodash__WEBPACK_IMPORTED_MODULE_1___default.a.forEach(selectedLayers, function (layer) {
      ...
      var svgCode = sketch__WEBPACK_IMPORTED_MODULE_0___default.a.export(layer, options).toString();
      var file = NSString.stringWithString(svgCode);
      var file_path = openPanel.directoryURL().path() + '/' + layerName + '.svg';
      var write = file.writeToFile_atomically_encoding_error(file_path, true, NSUTF8StringEncoding, null);
      console.log(write); // parsedSvgCode = parsedSvgCode
      //     .replace(
...
//# sourceMappingURL=__svgTokens.js.map