...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/radiiTokens.js");
/******/ })
/************************************************************************/
/******/ ({
...
var fieldLabel = function fieldLabel(pos, title, viewWidth, viewHeight) {
  var label = NSTextField.alloc().initWithFrame(NSMakeRect(0, viewHeight - pos, viewWidth, 35));
...
var fieldSelect = function fieldSelect(pos, values, viewWidth, viewHeight) {
  var namingSelect = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : false;
  var select = NSPopUpButton.alloc().initWithFrame(NSMakeRect(0, viewHeight - pos, viewWidth, 22));

  if (namingSelect) {
    var layerNames = values.map(function (layer) {
      return layer.name;
    });
...
var formatObject = function formatObject(obj, type, jsonTitle) {
  ...
  if (type == _strings__WEBPACK_IMPORTED_MODULE_2__["default"].values.json) {
    ...
    string = string.concat(lodash__WEBPACK_IMPORTED_MODULE_0___default.a.join(lodash__WEBPACK_IMPORTED_MODULE_0___default.a.map(obj, function (value, key) {
      return _values__WEBPACK_IMPORTED_MODULE_1__["default"][type].prefix + key + _values__WEBPACK_IMPORTED_MODULE_1__["default"][type].diviner + value + _values__WEBPACK_IMPORTED_MODULE_1__["default"][type].postfix;
    }), ''));
    string = string.concat(_values__WEBPACK_IMPORTED_MODULE_1__["default"][type].lineEnd);
  }

  return string;
};

/* harmony default export */ __webpack_exports__["default"] = (formatObject);
...
var dialogBox = function dialogBox(selectedLayers) {
  var alert = Object(_lib_dialogFields__WEBPACK_IMPORTED_MODULE_6__["dialogAlert"])('Export Radius Variables'); // Creating the view
  ...
  view.addSubview(dropdownFileType); //Dropdown: Units

  view.addSubview(Object(_lib_dialogFields__WEBPACK_IMPORTED_MODULE_6__["fieldLabel"])(90, 'Units:', viewWidth, viewHeight));
  var units = ['Relative (rem)', 'Absolute (px)'];
  dropdownUnits = Object(_lib_dialogFields__WEBPACK_IMPORTED_MODULE_6__["fieldSelect"])(100, units, viewWidth, viewHeight);
...
var exportRadiiStyles = function exportRadiiStyles(selectedLayers, type, naming, units) {
  ...
  savePanel.setNameFieldStringValue('radii.' + _lib_values__WEBPACK_IMPORTED_MODULE_2__["default"][type].filetype);
  ...
  if (savePanel.runModal() && selectedCount !== 0) {
    ...
    lodash__WEBPACK_IMPORTED_MODULE_1___default.a.forEach(selectedLayers, function (layer) {
      ...
      var space = units == 'Absolute (px)' ? radius + 'px' : radius / 16 + 'rem';
      variables[layerName] = space;
    });

    var file = NSString.stringWithString(Object(_lib_formatObject__WEBPACK_IMPORTED_MODULE_4__["default"])(variables, type, 'radii'));
    var file_path = savePanel.URL().path();
    file.writeToFile_atomically_encoding_error(file_path, true, NSUTF8StringEncoding, null);
    sketch__WEBPACK_IMPORTED_MODULE_0___default.a.UI.message('Radius Variables Exported!');
  }
};
/**
 *
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  if (selectedCount !== 0) {
    ...
    if (dialog == '1000') {
      exportRadiiStyles(selectedLayers, exportType, exportNaming, exportUnits);
    }
  } else {
...
//# sourceMappingURL=__radiiTokens.js.map