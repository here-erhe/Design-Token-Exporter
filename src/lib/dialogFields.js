...
export const dialogAlert = (title, desc = 'Choose variables format.') => {
...
export const fieldLabel = (pos, title, viewWidth, viewHeight) => {
    let label = NSTextField.alloc().initWithFrame(
        NSMakeRect(0, viewHeight - pos, viewWidth, 35)
    );
...
export const fieldSelect = (
    ...
    let select = NSPopUpButton.alloc().initWithFrame(
        NSMakeRect(0, viewHeight - pos, viewWidth, 22)
    );
...
export const fieldCheckbox = (
    ...
    let checkbox = NSButton.alloc().initWithFrame(
        NSMakeRect(0, viewHeight - pos, viewWidth, 20)
    );
