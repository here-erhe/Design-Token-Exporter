...
const tokenValue = (layer) => {
    ...
    if(layerType === "ShapePath"){
        ...
        if(_.indexOf(['spacing','space','spacer','sizing','size'], tokenCategory) !== -1){
            ...
            value = color.slice(-2) === "ff" ? color.substr(0, 7) : hexAToRGBA(color);
            ...
            let color = shadowArr.color.slice(-2) === "ff" ? shadowArr.color.substr(0, 7) : hexAToRGBA(shadowArr.color);
            ...
            value =  "inset " + x + " " + y + " " + blur + " " + spread + " " + color;
            ...
            let borderStyle = _.isEmpty(layer.style.borderOptions.dashPattern) ? "solid" : "dashed";
            ...
            // Token type color
            let color = _.last(layer.style.fills).color;
            let colorFormat = color.slice(-2) === "ff" ? color.substr(0, 7) : hexAToRGBA(color);
